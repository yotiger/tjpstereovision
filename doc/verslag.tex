...
to the camera. Such information is retreived by a dense stereo
...
original image, in order words if an object is white it is depending
...
enviroment and calculate the depthmap, you can create a 3D model of
...
on the depth of the pixels and their adjacency.
 \item[Recognising front objects] When you apply segmentation based on
